...
const INDUSTRIES = [
  { path: '/solutions/ecommerce', name: 'D2C & E-commerce', icon: '🛒', pain: 'Cart abandonment and COD returns eating your margins.', journeys: ['Cart recovery', 'COD confirm', 'Prepay nudge', 'Delivery updates', 'Win-back'], capabilities: ['OrderGuard™', 'Razorpay payments', 'Shopify integration'] },
  { path: '/solutions/clinics', name: 'Clinics & Healthcare', icon: '🏥', pain: 'No-shows leaving gaps in your schedule and revenue.', journeys: ['Appointment reminders', 'Report alerts', 'Feedback loop', 'Recall campaigns'], capabilities: ['BookGuard', 'Deposit collection', 'Google reviews'] },
  { path: '/solutions/salons', name: 'Salons & Spas', icon: '💇', pain: 'Empty chairs from last-minute cancellations.', journeys: ['Booking confirm', 'Rebooking nudge', 'Birthday offers', 'Loyalty rewards'], capabilities: ['BookGuard', 'Waitlist fills', 'Campaign broadcasts'] },
  { path: '/solutions/education', name: 'Coaching & Education', icon: '📚', pain: 'Enquiries going cold before they convert.', journeys: ['Enquiry follow-up', 'Fee reminders', 'Class updates', 'Re-enrolment'], capabilities: ['Lead scoring', 'Payment links', 'Batch broadcasts'] },
  { path: '/solutions/real-estate', name: 'Real Estate', icon: '🏠', pain: 'Leads going unanswered after hours.', journeys: ['Instant lead reply', 'Site visit booking', 'Follow-up drip', 'Project updates'], capabilities: ['Instant reply', 'Lead qualification', 'Booking collection'] },
  { path: '/solutions/services', name: 'Agencies & Services', icon: '🔧', pain: 'Quotes, bookings, and payments scattered across channels.', journeys: ['Quote follow-up', 'Booking confirm', 'Invoice reminders', 'Feedback request'], capabilities: ['BookGuard', 'Advance collection', 'Team inbox'] },
];
            ...
            <Link key={ind.path} to={ind.path} style={{ textDecoration: 'none' }}>
              <SpotlightCard>
                <div style={{ padding: 32 }}>
                  ...
                  <p style={{ fontSize: 14, color: '#94a3b8', lineHeight: 1.6, marginBottom: 20, fontFamily: "'Inter', sans-serif" }}>{ind.pain}</p>
